...
<br></br>
{{releaseDetails.modifiedOn}} / {{date releaseDetails.modifiedOn}} / {{(replace (date releaseDetails.modifiedOn) "+00:00" "-03:00")}} / {{date (replace (date releaseDetails.modifiedOn) "+00:00" "-03:00")}} / {{date (replace releaseDetails.modifiedOn "+00:00" "-03:00") "DD/MM/YYYY hh:mm"}}
<br></br>

...
<span style="color: rgba(0,0,0,0.7); font-size: 12px">[{{releaseDetails.name}}]({{releaseDetails._links.web.href}}) feito em `{{date (replace releaseDetails.modifiedOn "GMT+0000" "GMT-0300") "DD/MM/YYYY hh:mm"}}`  iniciado por @<{{releaseDetails.modifiedBy.uniqueName}}></span> - {{replace releaseDetails.modifiedOn "GMT+0000" "GMT-0300"}}
<br></br>
